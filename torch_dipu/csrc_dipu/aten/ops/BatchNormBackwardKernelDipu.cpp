...
::std::tuple<at::Tensor, at::Tensor, at::Tensor> DIPUNativeFunctions::native_batch_norm_backward(
    ...
    ::diopiConstTensorHandle_t grad_out_diopi = dipu::diopi::toDiopiTensorHandle(grad_out);
    ...
    ::diopiConstTensorHandle_t save_mean_diopi = dipu::diopi::toDiopiTensorHandle(save_mean_tensor);
    ::diopiConstTensorHandle_t save_invsted_diopi = dipu::diopi::toDiopiTensorHandle(save_invsted_tensor);
    ...
    ::diopiTensorHandle_t grad_bias_diopi = dipu::diopi::toDiopiTensorHandle(grad_bias);
