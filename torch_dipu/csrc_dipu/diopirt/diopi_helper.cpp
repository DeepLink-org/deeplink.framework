...
::diopiTensorHandle_t toDiopiTensorHandle(at::Tensor& tensor) { return tensor.defined() ? reinterpret_cast<::diopiTensorHandle_t>(&tensor) : nullptr; }
...
::diopiConstTensorHandle_t toDiopiTensorHandle(const at::Tensor* tensor) { return tensor == nullptr ? nullptr : toDiopiTensorHandle(*tensor); }
