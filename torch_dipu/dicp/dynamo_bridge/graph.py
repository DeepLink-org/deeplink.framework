...
class GraphTransformer:
    def __init__(
        ...
        if backend == 'topsgraph':
            from torch_dipu.dicp.vendor.TopsGraph.opset_transform import topsgraph_opset_transform
            self.backend_opset_transform = topsgraph_opset_transform
            from torch_dipu.dicp.vendor.TopsGraph.codegen.enflame import EnflameCodegen
            self.backend_codegen = EnflameCodegen
        elif backend == 'ascendgraph':
            from torch_dipu.dicp.vendor.AscendGraph.opset_convert import ascendgraph_opset_convert
            self.backend_opset_transform = ascendgraph_opset_convert
            from torch_dipu.dicp.vendor.AscendGraph.codegen.ascend import AscendCodegen
