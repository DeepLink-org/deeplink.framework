...
export DIPU_FORCE_FALLBACK_OPS_LIST=arange.start_out,mul.Scalar,mul_.Scalar,mul.Scalar_out,mul_.Tensor,mul.out,hardtanh_backward.grad_input,hardtanh_backward,uniform_
