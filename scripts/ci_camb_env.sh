...
export DIPU_FORCE_FALLBACK_OPS_LIST=arange.start_out,mul.Scalar,mul_.Scalar,mul.Scalar_out,mul_.Tensor,mul.out,hardtanh_backward.grad_input,hardtanh_backward,add_out,_index_put_impl_,scatter.value_out,scatter.value_reduce_out,scatter.src_out
