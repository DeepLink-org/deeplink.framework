...
original_list=(
    "mmpretrain resnet/resnet50_8xb32_in1k.py workdirs_resnet50_8xb32_in1k --resume=/mnt/lustre/share_data/PAT/datasets/pretrain/torchvision/resnet50-0676ba61.pth --no-pin-memory"   
