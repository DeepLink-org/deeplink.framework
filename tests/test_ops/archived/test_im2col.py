...
class TestSchema(TestCase):
    ...
    def test_im2col_col2im(self):
        ...
        for shape in ([1, 7, 8],):
            ...
            self._test_im2col_col2im(im, kernel_size = (1, 1), dilation = (1, 1), padding = (0, 0), stride = (1, 1))
            self._test_im2col_col2im(im, kernel_size = (2, 3), dilation = (1, 1), padding = (0, 0), stride = (1, 1))
            self._test_im2col_col2im(im, kernel_size = (3, 3), dilation = (1, 1), padding = (0, 0), stride = (1, 1))
            self._test_im2col_col2im(im, kernel_size = (3, 3), dilation = (1, 1), padding = (0, 0), stride = (1, 1))
            self._test_im2col_col2im(im, kernel_size = (3, 3), dilation = (2, 3), padding = (0, 0), stride = (1, 1))
            self._test_im2col_col2im(im, kernel_size = (3, 3), dilation = (1, 1), padding = (4, 5), stride = (1, 1))
            self._test_im2col_col2im(im, kernel_size = (3, 3), dilation = (2, 2), padding = (3, 3), stride = (2, 2))
