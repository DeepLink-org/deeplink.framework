...
DISABLED_TORCH_TESTS_GPU = common_utils.union_of_disabled_tests(
...
DISABLED_TORCH_TESTS = {
    ...
    'CPU': common_utils.prepare_match_set(DISABLED_TORCH_TESTS_CPU),
    'GPU': common_utils.prepare_match_set(DISABLED_TORCH_TESTS_GPU),
}