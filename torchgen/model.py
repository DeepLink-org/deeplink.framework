...
BACKEND_COMPONENTS = "CPU CUDA HIP XLA MPS IPU XPU HPU DIPU VE Lazy Meta PrivateUse1 PrivateUse2 PrivateUse3".split()
...
class NativeFunctionsGroup:
    ...
    def from_dict(
        ...
        assert not d
        # Temporarily comment out the assert and return None
