...
function(_set_cpp_flags)
  ...
  if (CMAKE_BUILD_TYPE MATCHES Debug)
    ...
    set(CMAKE_C_FLAGS "-Wl,-z,relro,-z,now,-s,-z,noexecstack -fPIE -pie ${CMAKE_C_FLAGS}")
    set(CMAKE_CXX_FLAGS "-Wl,-z,relro,-z,now,-s,-z,noexecstack -fPIE -pie ${CMAKE_CXX_FLAGS}")
    set(CXXFLAGS "-Wl,-z,relro,-z,now,-s,-z,noexecstack -fPIE -pie ${CXXFLAGS}")
  endif()
