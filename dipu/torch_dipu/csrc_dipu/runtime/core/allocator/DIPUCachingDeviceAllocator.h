...
using CreateContextFn = std::shared_ptr<c10::GatheredContext> (*)();
...
inline c10::Allocator* getTorchAllocator() {
  TORCH_CHECK(false, "not support torch allocator in torch2.0");
}
