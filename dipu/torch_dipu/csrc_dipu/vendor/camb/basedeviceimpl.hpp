...
void resetDevice(deviceId_t devId) { DIPU_CALLCNRT(::cnrtDeviceReset()) }

void syncDevice() { DIPU_CALLCNRT(::cnrtSyncDevice()) }
...
void waitEvent(deviceEvent_t event) { DIPU_CALLCNRT(::cnrtWaitNotifier(event)) }
