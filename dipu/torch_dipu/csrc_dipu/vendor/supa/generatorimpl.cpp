...
class SUPAGeneratorImpl : public dipu::DIPUGeneratorImpl {
protected:
  mutable std::once_flag init_state_flag;

public:
  SUPAGeneratorImpl(at::DeviceIndex device_index) : dipu::DIPUGeneratorImpl(device_index) {}
...
const at::Generator vendorMakeGenerator(at::DeviceIndex device_index) { return at::make_generator<SUPAGeneratorImpl>(device_index); }
