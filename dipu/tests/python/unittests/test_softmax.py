...
class Testsoftmax(TestCase):
    ...
    def test_softmax_shape_format_fp32_2d(self):
        format_list = [0, 3]
        shape_format = [[np.float32, i, [256, 1000]] for i in format_list]
        self.softmax_result(shape_format)

    # TODO:Fix me
    # def test_softmax_shape_format_fp16_3d(self):
    #     format_list = [0, 3]
    #     shape_format = [
    ...
    def test_softmax_shape_format_fp32_3d(self):
        format_list = [0, 3]
        shape_format = [[np.float32, i, [32, 48, 1024]] for i in format_list]
        self.softmax_result(shape_format)

    # TODO:Fix me
    # def test_softmax_shape_format_fp16_4d(self):
    #     format_list = [0, 3]
    #     shape_format = [
    ...
    def test_softmax_shape_format_fp32_4d(self):
        format_list = [0, 3]
        shape_format = [[np.float32, i, [32, 24, 18, 1000]] for i in format_list]
        self.softmax_result(shape_format)
