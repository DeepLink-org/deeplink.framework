...
class TestAddmm(TestCase):
    ...
    def dipu_op_exec_out(self, input1, input2, input3, scalar1, scalar2, input4):
        input1 = input1.to(dipu)
        input2 = input2.to(dipu)
        input3 = input3.to(dipu)
    ...
    @skipOn("CUDA", "'addmm_cuda' not implemented for 'Int'")
    def test_addmm_shape_format_int(self):
        format_list = [0]
        shape_list = [(3, 3), (3, 5), (5, 3)]
        shape_format1 = [[np.int32, i, shape_list[0]] for i in format_list]
        shape_format2 = [[np.int32, i, shape_list[1]] for i in format_list]
        shape_format3 = [[np.int32, i, shape_list[2]] for i in format_list]
        shape_format = [
            [i, j, k, "int32"]
            for i in shape_format1
            for j in shape_format2
            for k in shape_format3
        ]
    ...
    def test_addmm_shape_format_fp32(self):
        format_list = [0]
        shape_list = [(3, 3), (3, 5), (5, 3)]
        shape_format1 = [[np.float32, i, shape_list[0]] for i in format_list]
        shape_format2 = [[np.float32, i, shape_list[1]] for i in format_list]
        shape_format3 = [[np.float32, i, shape_list[2]] for i in format_list]
        shape_format = [
            [i, j, k, "float32"]
            for i in shape_format1
            for j in shape_format2
    ...
    #     format_list = [0]
    #     shape_list = [(3, 3), (3, 5), (5, 3)]
    #     shape_format1 = [[np.float16, i, shape_list[0]] for i in format_list]
    #     shape_format2 = [[np.float16, i, shape_list[1]] for i in format_list]
    #     shape_format3 = [[np.float16, i, shape_list[2]] for i in format_list]
    #     shape_format = [
    #         [i, j, k, "float16"]
    #         for i in shape_format1
    #         for j in shape_format2
