...
class TestConvTranspose2d(TestCase):
    ...
    def _init_module(
        ...
        self.cpu_module = torch.nn.ConvTranspose2d(
            in_channels,
            out_channels,
            kernel_size,
            stride,
        ...
        self.dipu_module = torch.nn.ConvTranspose2d(
            in_channels,
            out_channels,
            kernel_size,
            stride,
    ...
    def _run_conv_transpose2d(self):
        x1 = self.x.clone().cpu()
    ...
    def test_conv_transpose2d_equal_stride(self):
        self._init_module(16, 33, 3, stride=2)
        self._run_conv_transpose2d()

    def test_conv_transpose2d_unequal_stride(self):
        self._init_module(16, 33, (3, 5), stride=(2, 1), padding=(4, 2))
        self._run_conv_transpose2d()
