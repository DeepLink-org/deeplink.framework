...
export PYTORCH_DIR=${PLATFORM}/dep/DIOPI_pytorch/pytorch2.0_c263bd_cu117
...
export PYTORCH_TEST_DIR=${PLATFORM}/env/miniconda3.8/envs/${ENV_NAME}/pytorch2.0
