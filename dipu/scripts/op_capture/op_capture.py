...
def parase_args():
    ...
    parser.add_argument(
        "--train_log",
        type=str,
        default="dipu_train.log",
        help="Log file of model training (environment variable DIPU_DUMP_OP_ARGS=2 is set)",
    )
    parser.add_argument(
        "--out",
        type=str,
        default="dipu_ops.csv",
        help="The file to save the captured operator information",
    )
